...
SRC_URI="
	...
	https://github.com/secondlife/dullahan/releases/download/v1.25.0-CEF_139.0.40/dullahan-1.25.0.202510152245_139.0.40_g465474a_chromium-139.0.7258.139-linux64-18544680875.tar.zst
...
src_unpack() {
	...
	mv LICENSES autobuild-package.xml bin ca-bundle.crt dictionaries docs fonts include js lib meta mikktspace.txt resources xui viewer/indra_build/packages/
}
